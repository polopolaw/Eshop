...
@section('content')
    ...
    <section class="mt-16 lg:mt-24">
        <!-- Section heading -->
        <h2 class="text-lg lg:text-[42px] font-black">{{ __('Categories') }}</h2>
    ...
    <section class="mt-16 lg:mt-24">
        <!-- Section heading -->
        <h2 class="text-lg lg:text-[42px] font-black">{{ __('Catalog') }}</h2>
        ...
        <div class="mt-12 text-center">
            <a href="{{ route('catalog') }}" class="btn btn-purple">{{ __('All products') }} &nbsp;→</a>
        </div>
    </section>

    <section class="mt-20">
        <!-- Section heading -->
        <h2 class="text-lg lg:text-[42px] font-black">{{ __('Brands') }}</h2>
